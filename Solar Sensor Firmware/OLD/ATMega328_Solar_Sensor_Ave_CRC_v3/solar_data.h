...
class data_channel {
  public:
    ...
    // Need to work on conversion system
    float solar_conv_m;  // The conversion is y=mx+c, with the m and c here.
    float solar_conv_c;
    
    int send_solar_data = 5;   // This int sets if the wind speed data will be sent each time. If = 5 then no data sent,
